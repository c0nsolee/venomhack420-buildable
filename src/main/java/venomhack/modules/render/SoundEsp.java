        ...
        this.soundList.forEach((pair, time) -> {
            ...
            if (soundSet.getSubtitle() != null) {
                ...
                if (NametagUtils.to2D(soundPos, this.scale.get())) {
                    ...
                    Renderer2D.COLOR.quad(-width / 2.0 - 1.0, -height / 2.0 - 1.0, width + 2.0, height + 2.0, this.background.get());
                    Renderer2D.COLOR.render(null);
                    TextRenderer.get().begin(1.0, false, true);
                    TextRenderer.get().render(soundSet.getSubtitle().getString(), -width / 2.0, -height / 2.0, this.names.get());
