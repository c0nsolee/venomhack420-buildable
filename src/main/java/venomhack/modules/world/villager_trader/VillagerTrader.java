...
public class VillagerTrader extends ModuleHelper {
    ...
    private final Setting<Double> wallsRange = this.setting("walls-range", "The maximum range the villager can be traded with through walls.", Double.valueOf(5.0), 0.0, 6.0);
    ...
    public ArrayList<Item> getWantedTradeItems() {
        return new ArrayList(this.trades.get());
    }
