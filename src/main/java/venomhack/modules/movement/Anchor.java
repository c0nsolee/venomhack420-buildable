            ...
            if (!this.wasInHole || this.holeX1 != x && this.holeX2 != x || this.holeZ1 != z && this.holeZ2 != z || (this.holeX1 != this.holeX2 || this.holeZ1 != this.holeZ2) && this.maintainInDoubles.get()) {
                ...
                if (!(this.mc.player.getPitch() < (float) this.minPitch.get().intValue())) {
                    ...
                    if (this.foundHole) {
                        ...
                        ((IVec3d) this.mc.player.getVelocity()).set(this.deltaX, this.pull.get() ? -this.pullSpeed.get() / 20.0 : this.mc.player.getVelocity().y, this.deltaZ);
                        if (this.instantCenter.get()) {
                            this.mc.player.updatePosition(holeX, this.mc.player.getY(), holeZ);
                            this.mc.player.networkHandler.sendPacket(new PositionAndOnGround(this.mc.player.getX(), this.mc.player.getY(), this.mc.player.getZ(), this.mc.player.isOnGround()));
                        }
